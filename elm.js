...
var _user$project$Main$dataDecoder = A2(_elm_lang$core$Json_Decode_ops[':='], 'data', _elm_lang$core$Json_Decode$string);
var _user$project$Main$getTokenB64 = F2(
	function (username, password) {
		var encode = _truqu$elm_base64$Base64$encode(
			A2(
				_elm_lang$core$Basics_ops['++'],
				username,
...
var _user$project$Main$getData = F2(
	function (model, apiUrl) {
		return A2(
			_evancz$elm_http$Http$fromJson,
			_user$project$Main$dataDecoder,
			A2(
					...
					headers: _elm_lang$core$Native_List.fromArray(
						[
							...
							_1: A2(
								_elm_lang$core$Basics_ops['++'],
								'Basic ',
								A2(_user$project$Main$getTokenB64, model.username, 'api_token'))
						}
						]),
					url: apiUrl,
					body: _evancz$elm_http$Http$empty
...
var _user$project$Main$api = 'https://toggl.com/reports/api/v2/details';
var _user$project$Main$randomQuoteUrl = A2(
	_evancz$elm_http$Http$url,
	_user$project$Main$api,
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'user_agent', _1: 'both'},
			{ctor: '_Tuple2', _0: 'workspace_id', _1: '1587771'},
			{ctor: '_Tuple2', _0: 'grouping', _1: 'projects'},
			{ctor: '_Tuple2', _0: 'subgrouping', _1: 'time_entries'},
			{ctor: '_Tuple2', _0: 'order_field', _1: 'duration'},
			{ctor: '_Tuple2', _0: 'order_desc', _1: 'off'},
			{ctor: '_Tuple2', _0: 'rounding', _1: 'on'},
			{ctor: '_Tuple2', _0: 'since', _1: '2016-08-22'},
			{ctor: '_Tuple2', _0: 'until', _1: '2016-08-28'},
			{ctor: '_Tuple2', _0: 'date_format', _1: 'DD%2FMM%2FYYYY'}
		]));
var _user$project$Main$registerUrl = A2(
	_evancz$elm_http$Http$url,
	_user$project$Main$api,
	_elm_lang$core$Native_List.fromArray(
		[
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {username: a, logged: b, data: c, errorMsg: d};
	});
...
var _user$project$Main$GetDataSuccess = function (a) {
	return {ctor: 'GetDataSuccess', _0: a};
};
var _user$project$Main$SetUsername = function (a) {
	return {ctor: 'SetUsername', _0: a};
};
var _user$project$Main$AuthError = function (a) {
	return {ctor: 'AuthError', _0: a};
};
var _user$project$Main$getDataCmd = F2(
	function (model, apiUrl) {
		return A3(
			_elm_lang$core$Task$perform,
			_user$project$Main$AuthError,
			_user$project$Main$GetDataSuccess,
			A2(_user$project$Main$getData, model, apiUrl));
	});
		...
		switch (_p1.ctor) {
			...
			case 'GetData':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Main$getDataCmd, model, _user$project$Main$registerUrl)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{logged: true, errorMsg: '', data: _p1._0})),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$Main$view = function (model) {
		...
		return loggedIn ? A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(greeting)
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('You have super-secret access to protected quotes.')
						])),
					A2(
					_elm_lang$html$Html$div,
					_elm_lang$core$Native_List.fromArray(
						...
						[
								...
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											...
											_elm_lang$html$Html_Events$onClick(_user$project$Main$GetData)
										]),
									_elm_lang$core$Native_List.fromArray(
										[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text(model.data)
										]))
								]))
						]))
				])) : A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class(showError)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html_Attributes$for('username')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Token:')
										])),
									A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('jumbotron text-left')
			]),
		_elm_lang$core$Native_List.fromArray(
			[authBoxView]));
};
